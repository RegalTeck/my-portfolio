...
const Contact = () => {
  return (
    <div
      className="w-full h-screen font-LGaramond flex flex-col justify-center items-center "
      id="contact"
    >
      ...
      <div className=" w-3/4 h-3/4 flex justify-evenly border-4 border-indigo-200 border-x-indigo-500 p-4">
        <SocialsColumn />
        <motion.div
